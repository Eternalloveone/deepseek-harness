...
export const zh = {
  ...
  'delete.session': '删除会话',
  'delete.session.desc': '将永久删除“{name}”的全部对话记录，且无法撤销。',
  'delete.session.family': '将永久删除“{name}”及其全部版本（共 {count} 个会话）的对话记录，且无法撤销。',
  'delete.session.pending': '正在删除会话…',
  'archived.sessions.aria': '已归档会话',
...
export const en = {
  ...
  'delete.session.desc': 'This permanently deletes all conversation logs of “{name}” and cannot be undone.',
  'delete.session.family': 'This permanently deletes “{name}” and its whole version family ({count} sessions) — all conversation logs — and cannot be undone.',
  'delete.session.pending': 'Deleting session…',
  'archived.sessions.aria': 'Archived sessions',
