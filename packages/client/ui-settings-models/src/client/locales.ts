...
export const en = {
  ...
  modelReasoningEfforts: 'Thinking depth',
  modelReasoningEffortsPlaceholder: 'off, low=low, high=high',
  modelReasoningEffortsHint: 'Use comma-separated levels; add =wire-value when the gateway expects a custom spelling.',
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  modelReasoningEfforts: '思考深度',
  modelReasoningEffortsPlaceholder: 'off、low=low、high=high',
  modelReasoningEffortsHint: '使用逗号分隔等级；网关需要自定义拼写时添加 =线路值。',
  modelAdvanced: '容量',
  addModel: '添加模型',
  removeModel: '删除模型',
